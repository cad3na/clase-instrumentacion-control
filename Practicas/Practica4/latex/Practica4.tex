...
%----------------------------------------------------------------------------------------
	...
	\subsection{PWM}
		...
		Como puedes ver le estamos suministrando un pulso de $5 V$, pero no es constante, digamos que esta prendido el $50\%$ del tiempo. En dado caso, decimos que el $DC$\footnote{Duty Cycle} es de $50\%$, y la fórmula para el voltaje aparente en el elemento eléctrico conectado es:
...
\section{Hoja de Anotaciones}
	...
	\begin{enumerate}
		...
		\item Dibuja los diagramas para todos los sistemas que diseñaste. \newline \newline \newline \newline \newline \newline \newline \newline \newline \newline \newline \newline \newline \newline \newline
	\end{enumerate}
