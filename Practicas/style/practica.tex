...
\documentclass[paper=a5, fontsize=14pt]{scrartcl} % Tamaño de papel y letra para el documento

\usepackage[left=1cm, top=1cm, right=1cm, bottom=1cm, marginparwidth=0mm, marginparsep=0mm]{geometry}
