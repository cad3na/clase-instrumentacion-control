...
%-------------------------------------------------------------------------------
	...
	\subsection{Control On/Off}
		...
		Asi pues, podemos notar que funciona como un interruptor, justo lo que deseamos para nuestro control On/Off.
		Tan solo tenemos que tomar en cuenta, cual es nuestro voltaje de referencia $V_{ref}$, con el que queremos comparar nuestra señal.
%-------------------------------------------------------------------------------
%	EQUIPO
%-------------------------------------------------------------------------------
