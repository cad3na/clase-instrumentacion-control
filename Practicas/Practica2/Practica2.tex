...
%----------------------------------------------------------------------------------------
	...
	\subsection{Acondicionamiento}
		...
		\subsubsection{Amplificador}
		    ...
		    En este ejemplo la ganancia del amplificador es de $11$, esto lo podemos comprobar con la formula:
...
\section{Cuestionario - Práctica 2}
	...
	\begin{enumerate}
		...
		\item ¿Cuantos amplificadores se pueden construir con un solo circuito integrado LM358?\\ \\ \\ \\
